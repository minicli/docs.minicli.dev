...
2. [Your First Command](/docs/first-command/)
3. [Command Model](/docs/command-model/)

## Next lesson

Move to [Getting Started](/docs/getting-started/) and scaffold a real app.

## Explore instead

If you prefer concept-first reading, jump to [Architecture Concepts](/docs/architecture-concepts/).
