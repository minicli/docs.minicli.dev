...
Add user input contracts with [Arguments and Flags](/docs/arguments-and-flags/).

## Explore instead

If you want the full architectural map, continue in [Architecture Concepts](/docs/architecture-concepts/).
